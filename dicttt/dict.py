...
# Удаляет ключ key и возвращает его значение. Если ключ отсутствует и указан default, возвращает его. В противном случае вызывает исключение.
# Пример:
#
# d = {'a': 1, 'b': 2}
# value = d.pop('a')
...
# Возвращает значение ключа key, если он существует. Если ключ отсутствует, вставляет его со значением default (по умолчанию None) и возвращает это значение.
# Пример:
#
# d = {'a': 1}
